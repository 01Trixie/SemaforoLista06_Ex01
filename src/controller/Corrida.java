...
public class Corrida extends Thread {
	...
	public Corrida (int idCavaleiro, Semaphore tochaPega, Semaphore pedraPega, int portaCorreta) {
	...
	public void escolhaPorta (int idCavaleiro, int PORTA_CORRETA) {
		...
		if (portaEscolhida == PORTA_CORRETA) {
			System.out.println("Parabéns!!! o cavaleiro sobreviveu!");
		} else {
			System.out.println("Péssimo, o cavaleiro morreu...");
		}
	}
